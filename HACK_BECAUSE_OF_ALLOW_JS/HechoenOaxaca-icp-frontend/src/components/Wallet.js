                ...
                <Card.Body>
                  <Form>
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control type="number" value={recargaMonto} onChange={(e) => setRecargaMonto(Number(e.target.value))} min="0"/>
                    </Form.Group>
                ...
                <Card.Body>
                  <Form>
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control type="number" value={transferirMonto} onChange={(e) => setTransferirMonto(Number(e.target.value))} min="0"/>
                    </Form.Group>
                    <Form.Group className="mb-3">
                      <Form.Label>ID del Destinatario</Form.Label>
                      <Form.Control type="text" value={destinatarioId} onChange={(e) => setDestinatarioId(e.target.value)} placeholder="Ingresa el Principal ID del destinatario"/>
                    </Form.Group>
