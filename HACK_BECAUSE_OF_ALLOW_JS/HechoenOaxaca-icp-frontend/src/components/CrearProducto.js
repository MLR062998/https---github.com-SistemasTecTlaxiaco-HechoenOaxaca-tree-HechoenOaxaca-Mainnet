...
const CrearProducto = () => {
    ...
    const saveProduct = async (e) => {
        ...
        try {
            ...
            const result = await marketplaceBackend.createProducto(nombre, // Text
            precio, // Float
            descripcion, // Text
            tipo, // Text
            imageBlobs // [Blob]
            ...
            <Card.Body>
              ...
              <Form onSubmit={saveProduct}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" name="nombre" placeholder="Ej: Olla de barro" required/>
                </Form.Group>

                <Form.Group className="mb-3">
                  <Form.Label>Precio</Form.Label>
                  <Form.Control type="number" step="0.01" name="precio" placeholder="Ej: 15.99" required/>
                </Form.Group>

                <Form.Group className="mb-3">
                  <Form.Label>Descripción</Form.Label>
                  <Form.Control as="textarea" rows={2} name="descripcion" placeholder="Descripción breve" required/>
                </Form.Group>

                <Form.Group className="mb-3">
                  <Form.Label>Nombre del Artesano</Form.Label>
                  <Form.Control type="text" name="artesano" placeholder="Nombre del artesano" required/>
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="file" name="imagenes" accept="image/jpeg,image/png" multiple onChange={handleImageChange} required/>
                </Form.Group>
