...
const CarritoDeCliente = ({ carrito, setCarrito }) => {
    ...
    return (<div className="carrito-de-cliente">
      <h2 className="text-center">Mi Carrito</h2>

      {carrito.length === 0 ? (<p className="text-center">Tu carrito está vacío.</p>) : (<div className="productos-en-carrito">
          {carrito.map((producto) => (<Card key={producto.id} className="mb-3">
