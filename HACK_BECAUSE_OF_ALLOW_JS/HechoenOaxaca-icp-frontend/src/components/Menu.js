      ...
      <nav className="navbar navbar-expand-lg custom-navbar">
        <div className="container-fluid custom-container">
          ...
          <div className="custom-links-container">
            {!isAuthenticated ? (<button className="custom-button login-button" onClick={handleLogin}>
                Iniciar Sesión
              </button>) : (<>
                ...
                {userRole === "intermediario" && (<Link to="/intermediario-dashboard">Dashboard Intermediario</Link>)}
